      ...
      case 'ATTENDANCE_CORRECTION':
        ...
        return (
          <>
            ...
            <div className="flex items-center gap-3 mt-2 bg-neutral-800/80 p-3 rounded-lg border border-neutral-700 w-fit">
              <div>
                <label className="block text-xs text-neutral-500 mb-1">Check In</label>
                <input 
                  type="time" 
                  className="bg-neutral-900 border border-neutral-700 text-white text-sm rounded px-2 py-1 focus:border-blue-500 focus:outline-none" 
              ...
              <div key={req._id} className="p-4 bg-neutral-800/40 rounded-lg border border-neutral-800/50 flex flex-col sm:flex-row justify-between sm:items-center gap-4">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="px-4 py-2 bg-green-500/10 text-green-500 hover:bg-green-500/20 border border-green-500/20 rounded-lg transition-colors flex items-center gap-2 disabled:opacity-50 text-sm font-medium"
                  >
                  ...
                  <button
                    ...
                    disabled={acting === req._id}
                    className="px-4 py-2 bg-red-500/10 text-red-500 hover:bg-red-500/20 border border-red-500/20 rounded-lg transition-colors flex items-center gap-2 disabled:opacity-50 text-sm font-medium"
                  >
